    ...
    InitBackGround: function(img) {
        ...
        function t() {
            var t = e("script"),
                o = t.length,
                i = t[o - 1];
            return { l: o, z: n(i, "zIndex", -1), o: n(i, "opacity", .8), c: n(i, "color", "0,0,0"), n: n(i, "count", 99) }
        }
        ...
        // lightgray
        var backImg = 'url(' + img + ') no-repeat'
        m.id = l, m.style.cssText = "background: " + backImg + ";background-size: 100vw 100vh;position:fixed;top:0;left:0;z-index:" + d.z + ";opacity:" + d.o, e("body")[0].appendChild(m), o(), window.onresize = o, window.onmousemove = function(n) { n = n || window.event, y.x = n.clientX, y.y = n.clientY }, window.onmouseout = function() { y.x = null, y.y = null };
